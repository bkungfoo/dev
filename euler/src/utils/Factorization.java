...
public class Factorization {
	...
	public static void main (String [] args) {
		// for testing
		long n = 40000000000L;
		System.out.println(getNumFactors(n));
	...
	public static ArrayList<Long> getFactors (long n) {
		...
		if (isPerfectSquare(n)) {
			y.add((long) Math.sqrt(n));
		}
		return y;
	}
	
	/**
	 * Returns the number of factors for a particular number.
	 * Note that this algorithm may take time O(sqrt(n)), which is exponential time in the number of bits. Use sparingly.
	 * 
	 * @param n
	 * @return
	 */
	public static int getNumFactors (long n) {
		int y = 1;
